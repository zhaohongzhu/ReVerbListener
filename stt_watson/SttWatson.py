...
from stt_watson.recording.Record import Record
from stt_watson.utils.SignalHandler import SignalHandler
from stt_watson.watson_client.Client import Client


class SttWatson(threading.Thread):
    default_config = {
        'audio-chunk': 8000,
        'audio-rate': 16000,
        'channels': 1,
    ...
    def run(self):
        ...
        self.watsonClient.startStt(audioFd) # Blocked here
